  ...
  return (
    <div className="bg-location-img bg-cover bg-no-repeat bg-center">
      <div className='mx-40 py-10 gap-10 flex justify-center'>
        <iframe className="h-96 w-1/3" src="https://maps.google.com/maps?q=4-111%20J.%20Chanyungco%20St,%20Marikina,%201800%20Metro%20Manila&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"></iframe>
